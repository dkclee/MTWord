...
function generateVerseField(num) {
  return $(`<div class="form-group row verseField">
              <div class="col">
                  <input class="form-control input-ref" id="ref${num}" name="refs" required="" type="text" value="">
              </div>
              <div class="col">
                  <textarea class="form-control" id="verse${num}" disabled></textarea>
              </div>
              <div class="delete-field col-lg-1">
                  <button class="btn btn-sm btn-danger delete-field" type="button">
...
$('#').on("input", _.debounce(showSearchedCupcakes, 250));
